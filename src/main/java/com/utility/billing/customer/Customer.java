...
public class Customer {
    ...
    public Customer(Long id, String fullNames, String nationalId, String email, String phone, String address, CustomerStatus status, LocalDateTime createdAt) {
        this.id = id;
    ...
    public static class CustomerBuilder {
        ...
        public Customer build() {
            return new Customer(id, fullNames, nationalId, email, phone, address, status, createdAt);
        }
    }
}
